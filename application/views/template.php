      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="<?=base_url()?>profile.php"><img src="<?=base_url()?>assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=base_url()?>general.php">General</a></li>
                          <li><a  href="<?=base_url()?>buttons.php">Buttons</a></li>
                          <li><a  href="<?=base_url()?>panels.php">Panels</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="<?=base_url()?>todo_list.php">Todo List</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="<?=base_url()?>lock_screen.php">Lock Screen</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?=base_url()?>form_component.php">Form Components</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?=base_url()?>basic_table.php">Basic Table</a></li>
                          <li><a  href="<?=base_url()?>responsive_table.php">Responsive Table</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="<?=base_url()?>chartjs.php">Chartjs</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->                  
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url()?>index.html#" class="go-top">
