	  		...
	  		<div id="showtime"></div>
	  			<div class="col-lg-4 col-lg-offset-4">
	  				<div class="lock-screen">
		  				<h2><a data-toggle="modal" href="<?=base_url()?>#myModal"><i class="fa fa-lock"></i></a></h2>
		  				<p>UNLOCK</p>
				              ...
				              <div class="modal-dialog">
				                  <div class="modal-content">
				                      ...
				                      <div class="modal-body">
				                          <p class="centered"><img class="img-circle" width="80" src="<?=base_url()?>assets/img/ui-sam.jpg"></p>
